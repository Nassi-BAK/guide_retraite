...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'diagnostic.result.disclaimer': 'Cette estimation est fournie à titre informatif. Les montants réels peuvent varier selon votre régime, vos bonifications, et d\'autres facteurs. Consultez votre organisme de retraite pour une estimation officielle.',
    'diagnostic.result.recalculate': 'Recalculer',
    'diagnostic.warning.veryLow': 'Durée très courte : Moins de 5 ans de cotisation. Vous ne remplissez peut-être pas les conditions pour une pension complète.',
    'diagnostic.warning.low': 'Durée limitée : Moins de 10 ans de cotisation. Vos droits à la retraite peuvent être réduits.',
    'diagnostic.warning.lowPension': 'Montant faible : Votre pension mensuelle estimée est inférieure à 1 000 DH. Envisagez d\'autres sources de revenus.',
    'diagnostic.warning.maxPension': 'Taux maximum : Le taux de calcul dépasse 100%. Le montant réel sera limité à votre dernier salaire.',
    'diagnostic.warning.invalidAge': 'Âge invalide : L\'âge de départ à la retraite doit être supérieur à votre âge actuel.',
  ...
  ar: {
    ...
    'diagnostic.result.disclaimer': 'يتم توفير هذا التقدير لأغراض إعلامية. قد تختلف المبالغ الفعلية حسب نظامك ومكافآتك وعوامل أخرى. استشر مؤسسة التقاعد الخاصة بك للحصول على تقدير رسمي.',
    'diagnostic.result.recalculate': 'إعادة الحساب',
    'diagnostic.warning.veryLow': 'فترة قصيرة جداً: أقل من 5 سنوات اشتراك. قد لا تستوفي شروط المعاش الكامل.',
    'diagnostic.warning.low': 'فترة محدودة: أقل من 10 سنوات اشتراك. قد تكون حقوقك في التقاعد محدودة.',
    'diagnostic.warning.lowPension': 'مبلغ منخفض: معاشك الشهري المقدر أقل من 1000 درهم. فكر في مصادر دخل أخرى.',
    'diagnostic.warning.maxPension': 'معدل أقصى: معدل الحساب يتجاوز 100%. سيكون المبلغ الفعلي محدوداً بآخر راتب لك.',
    'diagnostic.warning.invalidAge': 'سن غير صحيح: سن التقاعد يجب أن يكون أعلى من عمرك الحالي.',
